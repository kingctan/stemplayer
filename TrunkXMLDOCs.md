...
<br>
<h2>Example</h2>
<pre><code>&lt;finalscore x="420" y="50" width="100" height="110" background="0x000000" alpha =".8" color="0xFFFFFF" displayduring="no"&gt;Score&lt;/finalscore&gt;<br>
</code></pre>
...
<li> <b>width:</b> Sets the width of the score. Default is 300/ OPTIONAL </li>
<li> <b>height</b>: Sets the height of of the score. Default is 300.  OPTIONAL </li>
<li> <b>background</b>: Sets the background colour of the score element; this is an RBG colour in written in HEX. If this empty then there is not background color Default is black.  OPTIONAL </li>
<li> <b>alpha:</b> Sets the transparency of the element. Because the score element is often put on top of the other elements, this can useful. Default is .5 OPTIONAL </li>
<li> <b>colour:</b> Sets the colour of the text; this is an RBG colour in written in HEX. Default is white OPTIONAL </li>
